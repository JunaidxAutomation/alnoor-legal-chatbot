      ...
      `https://7107.api.greenapi.com/waInstance${instance}/sendMessage/${token}`,
      {
        ...
        body: JSON.stringify({
          ...
          message:
            ...
            `Afsos ke saath inform karna hai ke is waqt appointment schedule nahi ho saki.\n\n` +
            `📞 *Dobara try karein:*\n` +
            `${BUSINESS_INFO.phone}\n` +
            `🕐 ${BUSINESS_INFO.timing}\n\n` +
            `━━━━━━━━━━━━━━━━━━━━\n` +
            `Inconvenience ke liye maafi chahte hain. 🙏\n\n` +
    ...
    return new NextResponse(`
      ...
      <style>
        *{box-sizing:border-box;margin:0;padding:0}
        body{font-family:system-ui,sans-serif;background:#fef2f2;display:flex;align-items:center;justify-content:center;min-height:100vh;padding:20px}
        ...
        h1{color:#dc2626;font-size:26px;font-weight:800;margin-bottom:8px}
        p{color:#6b7280;font-size:14px;line-height:1.6}
        .badge{background:#fef2f2;color:#dc2626;font-weight:700;padding:8px 20px;border-radius:9999px;font-size:13px;margin-top:20px;display:inline-block}
      </style>
      </head><body>
      <div class="card">
        <div class="icon">❌</div>
        <h1>Appointment Cancelled</h1>
        <p><strong>${name}</strong> ko cancellation WhatsApp bhej di gayi hai.</p>
